...
{
    public class NetworkStatisticInstaller : IDisposable, IStartable
    {
        ...
        public NetworkStatisticInstaller(NetworkStatisticViewModel networkStatisticViewModel, ClientToProxy clientToProxy, GameLoop gameLoop)
        {
