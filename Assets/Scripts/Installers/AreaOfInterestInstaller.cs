...
{
    public class AreaOfInterestInstaller: IDisposable,  IStartable
    {
        ...
        public AreaOfInterestInstaller(BatchSceneApplier batchSceneApplier, AreaOfInterestGateway gateway, AreaOfInterestViewModel areaOfInterestViewModel, GameLoop gameLoop)
        {
